...
class Bookmark(models.Model):
    ...
    user = models.ForeignKey(AUTH_USER_MODEL, verbose_name=_(u"users"), blank=True, null=True, on_delete=models.CASCADE)
...
class UserSettings(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL, verbose_name=_(u"users"), on_delete=models.CASCADE)
